...
@Component({
  selector: 'app-construction-customers',
  templateUrl: './construction-customers.component.html',
  styleUrls: ['./construction-customers.component.sass']
})
export class ConstructionCustomersComponent implements OnInit {
