...
export async function buildIso(
  ...
  autoTable(pdf, {
    ...
    body: [
      [ { content: `SERVICIO DE ASESORIA Y GESTION DE LINEA DE CREDITO`, colSpan: 1 }, { content: `S/ ${(iso.commission || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, styles: { halign: 'right', cellWidth: 30 } } ],
      [],
      [],
      [],
    ],
