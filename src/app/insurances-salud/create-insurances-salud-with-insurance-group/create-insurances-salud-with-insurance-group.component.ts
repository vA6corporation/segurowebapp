...
@Component({
  selector: 'app-create-insurances-salud-with-insurance-group',
  templateUrl: './create-insurances-salud-with-insurance-group.component.html',
  styleUrl: './create-insurances-salud-with-insurance-group.component.sass'
})
export class CreateInsurancesSaludWithInsuranceGroupComponent {
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesSaludService.createWithInsuranceGroup(insurance).subscribe(insurance => {
