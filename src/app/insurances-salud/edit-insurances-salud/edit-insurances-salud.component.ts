...
@Component({
  selector: 'app-edit-insurances-salud',
  templateUrl: './edit-insurances-salud.component.html',
  styleUrl: './edit-insurances-salud.component.sass'
})
export class EditInsurancesSaludComponent {
    constructor(
    ...
    private insuranceSaludId: string = '';
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.params.subscribe(params => {
            this.insuranceSaludId = params.insuranceSaludId
            this.insurancesSaludService.getInsuranceSaludById(this.insuranceSaludId).subscribe(insuranceSalud => {
                this.payments = insuranceSalud.payments
                this.formGroup.patchValue(insuranceSalud)
            });
        });
    }
    ...
    onChangeOffice() {
        if (this.formGroup.valid) {
            ...
            this.insurancesSaludService.updateOffice(this.insuranceSaludId, insurance.officeId).subscribe(() => {
    ...
    onAttachPdfPolicy() {
        const data: InsurancePdfData = {
            type: 'POLICY',
            insuranceId: this.insuranceSaludId,
        }
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesSaludService.update(insurance, this.payments, this.insuranceSaludId).subscribe(res => {
                this.navigationService.loadBarFinish();
