...
@Component({
  selector: 'app-edit-insurances-polizatrec',
  templateUrl: './edit-insurances-polizatrec.component.html',
  styleUrl: './edit-insurances-polizatrec.component.sass'
})
export class EditInsurancesPolizatrecComponent {
    constructor(
    ...
    private insurancePolizatrecId: string = '';
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.params.subscribe(params => {
            this.insurancePolizatrecId = params.insurancePolizatrecId
            this.insurancesPolizatrecService.getInsurancePolizatrecById(this.insurancePolizatrecId).subscribe(insurancePolizatrec => {
                this.payments = insurancePolizatrec.payments
                this.formGroup.patchValue(insurancePolizatrec)
            });
        });
    }
    ...
    onChangeOffice() {
        if (this.formGroup.valid) {
            ...
            this.insurancesPolizatrecService.updateOffice(this.insurancePolizatrecId, insurance.officeId).subscribe(() => {
    ...
    onAttachPdfPolicy() {
        const data: InsurancePdfData = {
            type: 'POLICY',
            insuranceId: this.insurancePolizatrecId,
        }
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesPolizatrecService.update(insurance, this.payments, this.insurancePolizatrecId).subscribe(res => {
                this.navigationService.loadBarFinish();
