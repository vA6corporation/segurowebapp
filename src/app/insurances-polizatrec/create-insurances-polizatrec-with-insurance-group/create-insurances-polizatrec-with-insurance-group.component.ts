...
@Component({
  selector: 'app-create-insurances-polizatrec-with-insurance-group',
  templateUrl: './create-insurances-polizatrec-with-insurance-group.component.html',
  styleUrl: './create-insurances-polizatrec-with-insurance-group.component.sass'
})
export class CreateInsurancesPolizatrecWithInsuranceGroupComponent {
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesPolizatrecService.createWithInsuranceGroup(insurance).subscribe(insurance => {
