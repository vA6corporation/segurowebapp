...
@Component({
    selector: 'app-edit-insurances-rcivil',
    templateUrl: './edit-insurances-rcivil.component.html',
    styleUrl: './edit-insurances-rcivil.component.sass'
})
export class EditInsurancesRcivilComponent {
    ...
    private insuranceRcivilId: string = '';
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.params.subscribe(params => {
            this.insuranceRcivilId = params.insuranceRcivilId
            this.insurancesRcivilService.getInsuranceRcivilById(this.insuranceRcivilId).subscribe(insuranceRcivil => {
                this.payments = insuranceRcivil.payments
                this.formGroup.patchValue(insuranceRcivil)
            });
        });
    }
    ...
    onChangeOffice() {
        if (this.formGroup.valid) {
            ...
            this.insurancesRcivilService.updateOffice(this.insuranceRcivilId, insurance.officeId).subscribe(() => {
    ...
    onAttachPdfPolicy() {
        const data: InsurancePdfData = {
            type: 'POLICY',
            insuranceId: this.insuranceRcivilId,
        }
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesRcivilService.update(insurance, this.payments, this.insuranceRcivilId).subscribe(res => {
                this.navigationService.loadBarFinish();
