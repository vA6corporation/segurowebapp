...
@Component({
  selector: 'app-create-insurances-rcivil-with-insurance-group',
  templateUrl: './create-insurances-rcivil-with-insurance-group.component.html',
  styleUrl: './create-insurances-rcivil-with-insurance-group.component.sass'
})
export class CreateInsurancesRcivilWithInsuranceGroupComponent {
    constructor(
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesRcivilService.createWithInsuranceGroup(insurance).subscribe(insurance => {
