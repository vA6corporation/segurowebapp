...
@Component({
  selector: 'app-create-insurances-multirriesgos-with-insurance-group',
  templateUrl: './create-insurances-multirriesgos-with-insurance-group.component.html',
...
export class CreateInsurancesMultirriesgosWithInsuranceGroupComponent {
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesMultirriesgosService.createWithInsuranceGroup(insurance).subscribe(insurance => {
