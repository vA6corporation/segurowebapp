...
export class EditInsurancesMultirriesgosComponent {
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.params.subscribe(params => {
            this.insuranceMultirriesgosId = params.insuranceMultirriesgosId
            this.insurancesMultirriesgosService.getInsuranceMultirriesgosById(this.insuranceMultirriesgosId).subscribe(insuranceMultirriesgos => {
                this.payments = insuranceMultirriesgos.payments
                this.formGroup.patchValue(insuranceMultirriesgos)
            });
        });
    }
    ...
    onChangeOffice() {
        if (this.formGroup.valid) {
            ...
            this.insurancesMultirriesgosService.updateOffice(this.insuranceMultirriesgosId, insurance.officeId).subscribe(() => {
    ...
    onAttachPdfPolicy() {
        const data: InsurancePdfData = {
            type: 'POLICY',
            insuranceId: this.insuranceMultirriesgosId,
        }
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesMultirriesgosService.update(insurance, this.payments, this.insuranceMultirriesgosId).subscribe(res => {
                this.navigationService.loadBarFinish();
