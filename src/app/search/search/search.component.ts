...
export class SearchComponent implements OnInit {
    ...
    displayedColumns: string[] = ['guaranteeType', 'partnership', 'business', 'policyNumber', 'endDate', 'price', 'status', 'actions'];
    guaranties: any[] = [];
    dataSource: any[] = [];
    length: number = 100;
    pageSize: number = 10;
    ...
    ngOnInit(): void {
        ...
        const { key, status, processStatusCode } = this.activatedRoute.snapshot.queryParams
    ...
    fetchData() {
        ...
        this.reportsService.getGuarantiesByKey(params).subscribe({
            next: guaranties => {
