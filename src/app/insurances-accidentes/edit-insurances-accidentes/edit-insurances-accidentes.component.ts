...
@Component({
  ...
  templateUrl: './edit-insurances-accidentes.component.html',
...
export class EditInsurancesAccidentesComponent {
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.params.subscribe(params => {
            this.insuranceAccidentesId = params.insuranceAccidentesId
            this.insurancesAccidentesService.getInsuranceAccidentesById(this.insuranceAccidentesId).subscribe(insuranceAccidentes => {
                this.payments = insuranceAccidentes.payments
                this.formGroup.patchValue(insuranceAccidentes)
            });
        });
    }
    ...
    onChangeOffice() {
        if (this.formGroup.valid) {
            ...
            this.insurancesAccidentesService.updateOffice(this.insuranceAccidentesId, insurance.officeId).subscribe(() => {
    ...
    onAttachPdfPolicy() {
        const data: InsurancePdfData = {
            type: 'POLICY',
            insuranceId: this.insuranceAccidentesId,
        }
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesAccidentesService.update(insurance, this.payments, this.insuranceAccidentesId).subscribe(res => {
                this.navigationService.loadBarFinish();
