...
@Component({
  selector: 'app-create-insurances-polizacar-with-insurance-group',
  templateUrl: './create-insurances-polizacar-with-insurance-group.component.html',
  styleUrl: './create-insurances-polizacar-with-insurance-group.component.sass'
})
export class CreateInsurancesPolizacarWithInsuranceGroupComponent {
    ...
    ngOnInit(): void {
        this.navigationService.setTitle('Nuevo Polizacar');
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesPolizacarService.createWithInsuranceGroup(insurance).subscribe(insurance => {
