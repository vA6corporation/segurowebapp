...
@Component({
  selector: 'app-edit-insurances-polizaear',
  templateUrl: './edit-insurances-polizaear.component.html',
  styleUrl: './edit-insurances-polizaear.component.sass'
})
export class EditInsurancesPolizaearComponent {
    constructor(
        private readonly formBuilder: UntypedFormBuilder,
        private readonly insurancesPolizaearService: InsurancesPolizaearService,
    ...
    private insurancePolizaearId: string = '';
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.params.subscribe(params => {
            this.insurancePolizaearId = params.insurancePolizaearId
            this.insurancesPolizaearService.getInsurancePolizaearById(this.insurancePolizaearId).subscribe(insurancePolizaear => {
                this.payments = insurancePolizaear.payments
                this.formGroup.patchValue(insurancePolizaear)
            });
        });
    }
    ...
    onChangeOffice() {
        if (this.formGroup.valid) {
            ...
            this.insurancesPolizaearService.updateOffice(this.insurancePolizaearId, insurance.officeId).subscribe(() => {
    ...
    onAttachPdfPolicy() {
        const data: InsurancePdfData = {
            type: 'POLICY',
            insuranceId: this.insurancePolizaearId,
        }
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesPolizaearService.update(insurance, this.payments, this.insurancePolizaearId).subscribe(res => {
                this.navigationService.loadBarFinish();
