...
@Component({
  selector: 'app-create-insurances-polizaear-with-insurance-group',
  templateUrl: './create-insurances-polizaear-with-insurance-group.component.html',
  styleUrl: './create-insurances-polizaear-with-insurance-group.component.sass'
})
export class CreateInsurancesPolizaearWithInsuranceGroupComponent {
    constructor(
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesPolizaearService.createWithInsuranceGroup(insurance).subscribe(insurance => {
