...
@Component({
    selector: 'app-edit-insurances-pempresarial',
    templateUrl: './edit-insurances-pempresarial.component.html',
    styleUrl: './edit-insurances-pempresarial.component.sass'
})
export class EditInsurancesPempresarialComponent {
    ...
    private insurancePempresarialId: string = '';
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.params.subscribe(params => {
            this.insurancePempresarialId = params.insurancePempresarialId
            this.insurancesPempresarialService.getInsurancePempresarialById(this.insurancePempresarialId).subscribe(insurancePempresarial => {
                this.payments = insurancePempresarial.payments
                this.formGroup.patchValue(insurancePempresarial)
            });
        });
    }
    ...
    onChangeOffice() {
        if (this.formGroup.valid) {
            ...
            this.insurancesPempresarialService.updateOffice(this.insurancePempresarialId, insurance.officeId).subscribe(() => {
    ...
    onAttachPdfPolicy() {
        const data: InsurancePdfData = {
            type: 'POLICY',
            insuranceId: this.insurancePempresarialId,
        }
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesPempresarialService.update(insurance, this.payments, this.insurancePempresarialId).subscribe(res => {
                this.navigationService.loadBarFinish();
