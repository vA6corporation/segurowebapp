...
@Component({
  selector: 'app-create-insurances-pempresarial-with-insurance-group',
  templateUrl: './create-insurances-pempresarial-with-insurance-group.component.html',
...
export class CreateInsurancesPempresarialWithInsuranceGroupComponent {
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesPempresarialService.createWithInsuranceGroup(insurance).subscribe(insurance => {
