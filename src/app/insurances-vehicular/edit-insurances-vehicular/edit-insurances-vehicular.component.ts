...
@Component({
    selector: 'app-edit-insurances-vehicular',
    templateUrl: './edit-insurances-vehicular.component.html',
    styleUrl: './edit-insurances-vehicular.component.sass'
})
export class EditInsurancesVehicularComponent {
    ...
    private insuranceVehicularId: string = '';
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.params.subscribe(params => {
            this.insuranceVehicularId = params.insuranceVehicularId
            this.insurancesVehicularService.getInsuranceVehicularById(this.insuranceVehicularId).subscribe(insuranceVehicular => {
                this.payments = insuranceVehicular.payments
                this.formGroup.patchValue(insuranceVehicular)
            });
        });
    }
    ...
    onChangeOffice() {
        if (this.formGroup.valid) {
            ...
            this.insurancesVehicularService.updateOffice(this.insuranceVehicularId, insurance.officeId).subscribe(() => {
    ...
    onAttachPdfPolicy() {
        const data: InsurancePdfData = {
            type: 'POLICY',
            insuranceId: this.insuranceVehicularId,
        }
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesVehicularService.update(insurance, this.payments, this.insuranceVehicularId).subscribe(res => {
                this.navigationService.loadBarFinish();
