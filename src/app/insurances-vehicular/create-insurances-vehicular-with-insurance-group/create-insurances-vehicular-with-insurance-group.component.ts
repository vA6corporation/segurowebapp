...
@Component({
  selector: 'app-create-insurances-vehicular-with-insurance-group',
  templateUrl: './create-insurances-vehicular-with-insurance-group.component.html',
  styleUrl: './create-insurances-vehicular-with-insurance-group.component.sass'
})
export class CreateInsurancesVehicularWithInsuranceGroupComponent {
    constructor(
    ...
    ngOnInit(): void {
        ...
        this.navigationService.setTitle('Nuevo Vehicular');
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesVehicularService.createWithInsuranceGroup(insurance).subscribe(insurance => {
