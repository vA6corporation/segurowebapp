...
@Component({
    selector: 'app-edit-insurances-vidaley',
    templateUrl: './edit-insurances-vidaley.component.html',
    styleUrl: './edit-insurances-vidaley.component.sass'
})
export class EditInsurancesVidaleyComponent {
    ...
    private insuranceVidaleyId: string = '';
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.params.subscribe(params => {
            this.insuranceVidaleyId = params.insuranceVidaleyId
            this.insurancesVidaleyService.getInsuranceVidaleyById(this.insuranceVidaleyId).subscribe(insuranceVidaley => {
                this.payments = insuranceVidaley.payments
                this.formGroup.patchValue(insuranceVidaley)
            });
        });
    }
    ...
    onChangeOffice() {
        if (this.formGroup.valid) {
            ...
            this.insurancesVidaleyService.updateOffice(this.insuranceVidaleyId, insurance.officeId).subscribe(() => {
    ...
    onAttachPdfPolicy() {
        const data: InsurancePdfData = {
            type: 'POLICY',
            insuranceId: this.insuranceVidaleyId,
        }
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesVidaleyService.update(insurance, this.payments, this.insuranceVidaleyId).subscribe(res => {
                this.navigationService.loadBarFinish();
