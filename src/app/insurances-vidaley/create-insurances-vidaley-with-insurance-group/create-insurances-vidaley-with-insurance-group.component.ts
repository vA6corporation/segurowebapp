...
@Component({
  selector: 'app-create-insurances-vidaley-with-insurance-group',
  templateUrl: './create-insurances-vidaley-with-insurance-group.component.html',
  styleUrl: './create-insurances-vidaley-with-insurance-group.component.sass'
})
export class CreateInsurancesVidaleyWithInsuranceGroupComponent {
    ...
    ngOnInit(): void {
        ...
        this.navigationService.setTitle('Nuevo Vidaley');
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesVidaleyService.createWithInsuranceGroup(insurance).subscribe(insurance => {
