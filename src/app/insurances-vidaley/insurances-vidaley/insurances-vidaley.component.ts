...
@Component({
  selector: 'app-insurances-vidaley',
  templateUrl: './insurances-vidaley.component.html',
  styleUrl: './insurances-vidaley.component.sass'
})
export class InsurancesVidaleyComponent {


    constructor(
        private readonly navigationService: NavigationService,
        private readonly insurancesVidaleyService: InsurancesVidaleyService,
    ...
    ngOnInit(): void {
        this.navigationService.setTitle('Vidaley');
        ...
        this.handleSearch$ = this.navigationService.handleSearch().subscribe(key => {
            ...
            this.insurancesVidaleyService.getInsurancesVidaleyByKey(key).subscribe(insurances => {
        ...
        this.handleClickMenu$ = this.navigationService.handleClickMenu().subscribe(id => {
            ...
            if (id == 'export_excel') {
                ...
                for (let index = 0; index < this.length / chunk; index++) {
                    const promise = lastValueFrom(this.insurancesVidaleyService.getInsurancesVidaleyByPage(index + 1, chunk, params))
                ...
                Promise.all(promises).then(values => {
                    ...
                    const name = `SEGUROS_Vidaley_${formatDate(new Date(), 'dd/MM/yyyy', 'en-US')}`;
    ...
    async onDelete(insuranceId: string) {
        ...
        if (ok) {
            this.insurancesVidaleyService.delete(insuranceId).subscribe(() => {
    ...
    fetchData() {
        ...
        this.insurancesVidaleyService.getCountInsurancesVidaley(params).subscribe(count => {
            this.length = count;
        });

        this.navigationService.loadBarStart();
        this.insurancesVidaleyService.getInsurancesVidaleyByPage(this.pageIndex + 1, this.pageSize, params).subscribe(insurancesVidaley => {
            this.navigationService.loadBarFinish();
            this.dataSource = insurancesVidaley;
        });
    }
