...
@Component({
  selector: 'app-create-insurances-soat-with-insurance-group',
  templateUrl: './create-insurances-soat-with-insurance-group.component.html',
  styleUrl: './create-insurances-soat-with-insurance-group.component.sass'
})
export class CreateInsurancesSoatWithInsuranceGroupComponent {
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesSoatService.createWithInsuranceGroup(insurance).subscribe(insurance => {
