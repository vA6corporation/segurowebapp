...
export class EditInsurancesSoatComponent {
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.params.subscribe(params => {
            this.insuranceSoatId = params.insuranceSoatId
            this.insurancesSoatService.getInsuranceSoatById(this.insuranceSoatId).subscribe(insuranceSoat => {
                this.payments = insuranceSoat.payments
                this.formGroup.patchValue(insuranceSoat)
            });
        });
    }
    ...
    onChangeOffice() {
        if (this.formGroup.valid) {
            ...
            this.insurancesSoatService.updateOffice(this.insuranceSoatId, insurance.officeId).subscribe(() => {
    ...
    onAttachPdfPolicy() {
        const data: InsurancePdfData = {
            type: 'POLICY',
            insuranceId: this.insuranceSoatId,
        }
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesSoatService.update(insurance, this.payments, this.insuranceSoatId).subscribe(res => {
                this.navigationService.loadBarFinish();
