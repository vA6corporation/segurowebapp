...
@Component({
  ...
  templateUrl: './insurances-sctr.component.html',
  styleUrl: './insurances-sctr.component.sass'
})
export class InsurancesSctrComponent {
    ...
    ngOnInit(): void {
        this.navigationService.setTitle('Sctr');
        ...
        this.handleSearch$ = this.navigationService.handleSearch().subscribe(key => {
            ...
            this.insurancesSctrService.getInsurancesSctrByKey(key).subscribe(insurances => {
        ...
        this.handleClickMenu$ = this.navigationService.handleClickMenu().subscribe(id => {
            ...
            if (id == 'export_excel') {
                ...
                for (let index = 0; index < this.length / chunk; index++) {
                    const promise = this.insurancesSctrService.getInsurancesSctrByPage(index + 1, chunk, params).toPromise();
    ...
    async onDelete(insuranceId: string) {
        ...
        if (ok) {
            this.insurancesSctrService.delete(insuranceId).subscribe(() => {
