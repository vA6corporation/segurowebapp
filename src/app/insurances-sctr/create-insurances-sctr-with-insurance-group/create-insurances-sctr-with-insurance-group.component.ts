...
@Component({
  selector: 'app-create-insurances-sctr-with-insurance-group',
  templateUrl: './create-insurances-sctr-with-insurance-group.component.html',
  styleUrl: './create-insurances-sctr-with-insurance-group.component.sass'
})
export class CreateInsurancesSctrWithInsuranceGroupComponent {
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesSctrService.createWithInsuranceGroup(insurance).subscribe(insurance => {
