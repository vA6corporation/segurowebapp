...
export class EditInsurancesViajeComponent {
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.params.subscribe(params => {
            this.insuranceViajeId = params.insuranceViajeId
            this.insurancesViajeService.getInsuranceViajeById(this.insuranceViajeId).subscribe(insuranceViaje => {
                this.payments = insuranceViaje.payments
                this.formGroup.patchValue(insuranceViaje)
            });
        });
    }
    ...
    onChangeOffice() {
        if (this.formGroup.valid) {
            ...
            this.insurancesViajeService.updateOffice(this.insuranceViajeId, insurance.officeId).subscribe(() => {
    ...
    onAttachPdfPolicy() {
        const data: InsurancePdfData = {
            type: 'POLICY',
            insuranceId: this.insuranceViajeId,
        }
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesViajeService.update(insurance, this.payments, this.insuranceViajeId).subscribe(res => {
                this.navigationService.loadBarFinish();
