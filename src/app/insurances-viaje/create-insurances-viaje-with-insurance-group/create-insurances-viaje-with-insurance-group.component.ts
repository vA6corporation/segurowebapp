...
@Component({
  selector: 'app-create-insurances-viaje-with-insurance-group',
  templateUrl: './create-insurances-viaje-with-insurance-group.component.html',
  styleUrl: './create-insurances-viaje-with-insurance-group.component.sass'
})
export class CreateInsurancesViajeWithInsuranceGroupComponent {
    ...
    ngOnInit(): void {
        this.navigationService.setTitle('Nuevo Viaje');
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesViajeService.createWithInsuranceGroup(insurance).subscribe(insurance => {
