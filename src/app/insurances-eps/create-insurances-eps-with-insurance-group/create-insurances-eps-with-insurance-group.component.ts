...
@Component({
  selector: 'app-create-insurances-eps-with-insurance-group',
  templateUrl: './create-insurances-eps-with-insurance-group.component.html',
  styleUrl: './create-insurances-eps-with-insurance-group.component.sass'
})
export class CreateInsurancesEpsWithInsuranceGroupComponent {
    constructor(
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesEpsService.createWithInsuranceGroup(insurance).subscribe(insurance => {
