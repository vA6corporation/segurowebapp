...
@Component({
  selector: 'app-edit-insurances-eps',
  templateUrl: './edit-insurances-eps.component.html',
  styleUrl: './edit-insurances-eps.component.sass'
})
export class EditInsurancesEpsComponent {
    constructor(
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.params.subscribe(params => {
            this.insuranceEpsId = params.insuranceEpsId
            this.insurancesEpsService.getInsuranceEpsById(this.insuranceEpsId).subscribe(insuranceEps => {
                this.payments = insuranceEps.payments
                this.formGroup.patchValue(insuranceEps)
            });
        });
    }
    ...
    onChangeOffice() {
        if (this.formGroup.valid) {
            ...
            this.insurancesEpsService.updateOffice(this.insuranceEpsId, insurance.officeId).subscribe(() => {
    ...
    onAttachPdfPolicy() {
        const data: InsurancePdfData = {
            type: 'POLICY',
            insuranceId: this.insuranceEpsId,
        }
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesEpsService.update(insurance, this.payments, this.insuranceEpsId).subscribe(res => {
                this.navigationService.loadBarFinish();
