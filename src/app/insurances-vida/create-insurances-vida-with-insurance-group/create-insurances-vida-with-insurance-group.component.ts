...
@Component({
  selector: 'app-create-insurances-vida-with-insurance-group',
  templateUrl: './create-insurances-vida-with-insurance-group.component.html',
  styleUrl: './create-insurances-vida-with-insurance-group.component.sass'
})
export class CreateInsurancesVidaWithInsuranceGroupComponent {
    ...
    ngOnInit(): void {
        ...
        this.navigationService.setTitle('Nuevo Vida');
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesVidaService.createWithInsuranceGroup(insurance).subscribe(insurance => {
