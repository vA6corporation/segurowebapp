...
@Component({
  ...
  templateUrl: './edit-insurances-vida.component.html',
...
export class EditInsurancesVidaComponent {
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.params.subscribe(params => {
            this.insuranceVidaId = params.insuranceVidaId
            this.insurancesVidaService.getInsuranceVidaById(this.insuranceVidaId).subscribe(insuranceVida => {
                this.payments = insuranceVida.payments
                this.formGroup.patchValue(insuranceVida)
            });
        });
    }
    ...
    onChangeOffice() {
        if (this.formGroup.valid) {
            ...
            this.insurancesVidaService.updateOffice(this.insuranceVidaId, insurance.officeId).subscribe(() => {
    ...
    onAttachPdfPolicy() {
        const data: InsurancePdfData = {
            type: 'POLICY',
            insuranceId: this.insuranceVidaId,
        }
    ...
    onSubmit(): void {
        if (this.formGroup.valid) {
            ...
            this.insurancesVidaService.update(insurance, this.payments, this.insuranceVidaId).subscribe(res => {
                this.navigationService.loadBarFinish();
