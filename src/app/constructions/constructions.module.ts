...
@NgModule({
  declarations: [
    ...
    DialogAddBailComponent, DialogPercentCompletionsComponent, PercentCompletionsComponent, CollectionComponent, UpdatePercentCompletionsComponent, ConstructionsCommercialComponent 
  ],
  imports: [
    CommonModule,
